...
//required
$data['r'] = 'enable';         // request type [add/delete/edit/disable/enable/notify] >> more here https://noczone.com/?page=api
...
//optional
$data['reason'] = 'enable reason';    // reason for disable, will be sent as a message or the user
