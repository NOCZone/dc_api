...
//required
$data['r'] = 'delete';         // request type [add/delete/edit/disable/enable/notify] >> more here https://noczone.com/?page=api
$data['ip'] = '1.1.1.1';    //  IP Address of the server / NO DOMAIN NAMES only IPv4
$data['ip'] = array('1.1.1.1','2.2.2.2');    //  array of IPs is also possible

//optional
$data['reason'] = 'deletion reason';    // reason for deletion, will be sent as a message or the user
