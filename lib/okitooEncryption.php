...
class okitooEncryption {
	public static function encrypt($data, $client_key) {
		$key = hash('SHA256', $client_key, true);
	...
	public static function decrypt($encrypted, $client_key) {
		$key = hash('SHA256', $client_key, true);
